...
Route::group(['namespace' => 'API\v1', 'prefix' => 'v1', 'as' => 'api.v1.'], function () {
    ...
    Route::group(['middleware' => ['scope:superadmin,cliente-transacciones,cliente-suscripciones']], function () {
        Route::apiResource('/plan', 'PlanController');
            Route::get('/plan/id_externo/{id_externo}', 'PlanController@showExterno')->name('plan.id_externo');
            Route::get('/plan/{uuid}/suscripcion', 'PlanController@suscripciones')->name('plan.suscripciones');
            Route::get('/plan/{uuid}/suscripcion/cancelar', 'PlanController@cancelarSuscripciones')->name('plan.suscripciones.cancelar');
